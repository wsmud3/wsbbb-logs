...
**心跳**: 2026-08-23 20:47:01 UTC / 北京时间 2026-08-24 04:47:01

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 1 | 1 | 0d 9h 9m |
| 正式服(200) | running | 0 | 0 | 0d 10h 26m |

## Web 服务

- status: ok | 运行 0d 10h 26m | rss 99MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3760 | 97MB | 0d 9h 9m |
| mud-game | online | 3688 | 94MB | 0d 10h 26m |
| mud-web | online | 3598 | 99MB | 0d 10h 26m |
...
✓ built in 380ms
[2026-08-23 20:45:07] 前端构建完成 4015058（www/ 已更新）
```
