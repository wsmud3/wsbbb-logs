...
**心跳**: 2026-08-26 19:02:02 UTC / 北京时间 2026-08-27 03:02:02

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 1 | 0 | 0d 5h 48m |
| 正式服(200) | running | 1 | 0 | 1d 6h 41m |
...
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3771 | 96MB | 0d 5h 48m |
| mud-game | online | 3694 | 98MB | 1d 6h 41m |
| mud-web | online | 3604 | 100MB | 1d 6h 41m |
...
[2026-08-26 19:00:06] 错误：前端构建失败 767c885，前端保持旧版本，下轮自动重试
```
