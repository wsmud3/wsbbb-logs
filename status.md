...
**心跳**: 2026-08-28 14:07:02 UTC / 北京时间 2026-08-28 22:07:02

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 2 | 1 | 2d 0h 53m |
| 正式服(200) | running | 0 | 0 | 3d 1h 46m |

## Web 服务

- status: ok | 运行 3d 1h 46m | rss 92MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3771 | 99MB | 2d 0h 53m |
| mud-game | online | 3694 | 97MB | 3d 1h 46m |
| mud-web | online | 3604 | 92MB | 3d 1h 46m |
...
[2026-08-28 14:05:08] 错误：前端构建失败 2773c3b，前端保持旧版本，下轮自动重试
```
