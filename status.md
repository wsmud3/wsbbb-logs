...
**心跳**: 2026-08-26 12:17:01 UTC / 北京时间 2026-08-26 20:17:01

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 4 | 0 | 0d 23h 56m |
| 正式服(200) | running | 1 | 0 | 0d 23h 56m |

## Web 服务

- status: ok | 运行 0d 23h 56m | rss 100MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3770 | 94MB | 0d 23h 56m |
| mud-game | online | 3694 | 98MB | 0d 23h 56m |
| mud-web | online | 3604 | 100MB | 0d 23h 56m |
...
[2026-08-26 12:15:10] 错误：前端构建失败 767c885，前端保持旧版本，下轮自动重试
```
