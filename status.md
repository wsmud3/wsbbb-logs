...
**心跳**: 2026-08-21 20:32:01 UTC / 北京时间 2026-08-22 04:32:01

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 1 | 0 | 0d 0h 59m |
| 正式服(200) | running | 0 | 0 | 0d 11h 0m |

## Web 服务

- status: ok | 运行 0d 11h 0m | rss 99MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3730 | 91MB | 0d 0h 59m |
| mud-game | online | 3668 | 97MB | 0d 11h 0m |
| mud-web | online | 3579 | 99MB | 0d 11h 0m |
...
✓ built in 386ms
[2026-08-21 20:30:07] 前端构建完成 da466dd（www/ 已更新）
```
