...
**心跳**: 2026-08-24 17:22:02 UTC / 北京时间 2026-08-25 01:22:02

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 3 | 0 | 0d 19h 10m |
| 正式服(200) | running | 0 | 0 | 1d 7h 1m |

## Web 服务

- status: ok | 运行 1d 7h 1m | rss 100MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3764 | 100MB | 0d 19h 10m |
| mud-game | online | 3688 | 96MB | 1d 7h 1m |
| mud-web | online | 3598 | 100MB | 1d 7h 1m |
...
✓ built in 421ms
[2026-08-24 17:20:06] 前端构建完成 4015058（www/ 已更新）
```
