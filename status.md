...
**心跳**: 2026-08-24 12:17:01 UTC / 北京时间 2026-08-24 20:17:01

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 4 | 0 | 0d 14h 5m |
| 正式服(200) | running | 0 | 0 | 1d 1h 56m |

## Web 服务

- status: ok | 运行 1d 1h 56m | rss 95MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3764 | 99MB | 0d 14h 5m |
| mud-game | online | 3688 | 95MB | 1d 1h 56m |
| mud-web | online | 3598 | 95MB | 1d 1h 56m |
...
✓ built in 381ms
[2026-08-24 12:15:07] 前端构建完成 4015058（www/ 已更新）
```
