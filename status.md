...
**心跳**: 2026-08-23 05:32:02 UTC / 北京时间 2026-08-23 13:32:02

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 4 | 0 | 0d 4h 1m |
| 正式服(200) | running | 0 | 0 | 0d 4h 1m |

## Web 服务

- status: ok | 运行 0d 4h 1m | rss 95MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3750 | 94MB | 0d 4h 1m |
| mud-game | online | 3679 | 90MB | 0d 4h 1m |
| mud-web | online | 3589 | 95MB | 0d 4h 1m |
...
✓ built in 450ms
[2026-08-23 05:30:09] 前端构建完成 b8ad7e4（www/ 已更新）
```
