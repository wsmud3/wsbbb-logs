...
**心跳**: 2026-08-21 22:32:02 UTC / 北京时间 2026-08-22 06:32:02

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 1 | 0 | 0d 0h 41m |
| 正式服(200) | running | 0 | 0 | 0d 13h 0m |

## Web 服务

- status: ok | 运行 0d 13h 0m | rss 101MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3731 | 94MB | 0d 0h 41m |
| mud-game | online | 3668 | 97MB | 0d 13h 0m |
| mud-web | online | 3579 | 101MB | 0d 13h 0m |
...
✓ built in 433ms
[2026-08-21 22:30:06] 前端构建完成 da466dd（www/ 已更新）
```
