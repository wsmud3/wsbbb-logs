...
**心跳**: 2026-08-27 11:02:02 UTC / 北京时间 2026-08-27 19:02:02

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 1 | 0 | 0d 21h 48m |
| 正式服(200) | running | 0 | 0 | 1d 22h 41m |

## Web 服务

- status: ok | 运行 1d 22h 41m | rss 100MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3771 | 99MB | 0d 21h 48m |
| mud-game | online | 3694 | 96MB | 1d 22h 41m |
| mud-web | online | 3604 | 100MB | 1d 22h 41m |
...
[2026-08-27 11:00:07] 错误：前端构建失败 767c885，前端保持旧版本，下轮自动重试
```
