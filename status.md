...
**心跳**: 2026-08-22 12:47:02 UTC / 北京时间 2026-08-22 20:47:02

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 1 | 0 | 0d 2h 3m |
| 正式服(200) | running | 0 | 0 | 0d 0h 53m |

## Web 服务

- status: ok | 运行 1d 3h 15m | rss 100MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3740 | 94MB | 0d 2h 3m |
| mud-game | online | 3669 | 88MB | 0d 0h 53m |
| mud-web | online | 3579 | 100MB | 1d 3h 15m |
...
✓ built in 428ms
[2026-08-22 12:45:07] 前端构建完成 da466dd（www/ 已更新）
```
