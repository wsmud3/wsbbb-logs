...
**心跳**: 2026-08-26 11:37:02 UTC / 北京时间 2026-08-26 19:37:02

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 3 | 0 | 0d 23h 16m |
| 正式服(200) | running | 1 | 0 | 0d 23h 16m |

## Web 服务

- status: ok | 运行 0d 23h 16m | rss 100MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3770 | 93MB | 0d 23h 16m |
| mud-game | online | 3694 | 98MB | 0d 23h 16m |
| mud-web | online | 3604 | 100MB | 0d 23h 16m |
...
[2026-08-26 11:35:07] 错误：前端构建失败 767c885，前端保持旧版本，下轮自动重试
```
