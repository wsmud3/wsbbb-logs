...
**心跳**: 2026-08-25 13:27:02 UTC / 北京时间 2026-08-25 21:27:02
...
| 正式服(200) | running | 1 | 0 | 0d 1h 6m |

## Web 服务

- status: ok | 运行 0d 1h 6m | rss 93MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3770 | 91MB | 0d 1h 6m |
| mud-game | online | 3694 | 91MB | 0d 1h 6m |
| mud-web | online | 3604 | 93MB | 0d 1h 6m |
...
[2026-08-25 13:25:07] 错误：前端构建失败 767c885，前端保持旧版本，下轮自动重试
[2026-08-25 13:25:07] 中止：前端构建失败，暂不 reload，等待下一轮重试
```
