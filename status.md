...
**心跳**: 2026-08-26 14:12:02 UTC / 北京时间 2026-08-26 22:12:02

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 2 | 0 | 0d 0h 58m |
| 正式服(200) | running | 1 | 0 | 1d 1h 51m |

## Web 服务

- status: ok | 运行 1d 1h 51m | rss 100MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3771 | 93MB | 0d 0h 58m |
| mud-game | online | 3694 | 99MB | 1d 1h 51m |
| mud-web | online | 3604 | 100MB | 1d 1h 51m |
...
[2026-08-26 14:10:06] 错误：前端构建失败 767c885，前端保持旧版本，下轮自动重试
```
