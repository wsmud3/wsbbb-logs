...
**心跳**: 2026-08-26 16:27:02 UTC / 北京时间 2026-08-27 00:27:02
...
| 正式服(200) | running | 1 | 0 | 1d 4h 6m |

## Web 服务

- status: ok | 运行 1d 4h 6m | rss 100MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3771 | 96MB | 0d 3h 13m |
| mud-game | online | 3694 | 98MB | 1d 4h 6m |
| mud-web | online | 3604 | 100MB | 1d 4h 6m |
...
[2026-08-26 16:25:06] 错误：前端构建失败 767c885，前端保持旧版本，下轮自动重试
```
