...
**心跳**: 2026-08-22 15:27:02 UTC / 北京时间 2026-08-22 23:27:02

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 2 | 0 | 0d 4h 43m |
| 正式服(200) | running | 1 | 0 | 0d 3h 33m |

## Web 服务

- status: ok | 运行 1d 5h 55m | rss 101MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3740 | 98MB | 0d 4h 43m |
| mud-game | online | 3669 | 94MB | 0d 3h 33m |
| mud-web | online | 3579 | 101MB | 1d 5h 55m |
...
✓ built in 433ms
[2026-08-22 15:25:07] 前端构建完成 da466dd（www/ 已更新）
```
