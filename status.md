...
**心跳**: 2026-08-22 13:27:01 UTC / 北京时间 2026-08-22 21:27:01

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 1 | 0 | 0d 2h 43m |
| 正式服(200) | running | 0 | 0 | 0d 1h 33m |

## Web 服务

- status: ok | 运行 1d 3h 55m | rss 101MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3740 | 94MB | 0d 2h 43m |
| mud-game | online | 3669 | 89MB | 0d 1h 33m |
| mud-web | online | 3579 | 101MB | 1d 3h 55m |
...
✓ built in 394ms
[2026-08-22 13:25:08] 前端构建完成 da466dd（www/ 已更新）
```
