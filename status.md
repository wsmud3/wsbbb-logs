...
**心跳**: 2026-08-21 22:27:02 UTC / 北京时间 2026-08-22 06:27:02

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 1 | 0 | 0d 0h 36m |
| 正式服(200) | running | 0 | 0 | 0d 12h 55m |

## Web 服务

- status: ok | 运行 0d 12h 55m | rss 101MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3731 | 94MB | 0d 0h 36m |
| mud-game | online | 3668 | 97MB | 0d 12h 55m |
| mud-web | online | 3579 | 101MB | 0d 12h 55m |
...
[2026-08-21 19:32:33] [FATAL] 未捕获异常 | {"message":"lv is not defined","stack":"ReferenceError: lv is not defined\n    at BASE.on_damage (/home/mud/mud/world/skill/force/changshengjue.js:79:32)\n    at CHARACTER.damage (/home/mud/mud/world/extends/char/combat.js:418:31)\n    at Object.on_interval (/home/mud/mud/world/skill/force/nixianmojue.js:255:37)\n    at CHARACTER.remove_status (/home/mud/mud/os/char/chara_skill.js:607:30)\n    at listOnTimeout (node:internal/timers:605:17)\n    at process.processTimers (node:internal/timers:541:7)"}
[2026-08-21 21:50:52] [FATAL] 未捕获异常 | {"message":"lv is not defined","stack":"ReferenceError: lv is not defined\n    at BASE.on_damage (/home/mud/mud/world/skill/force/changshengjue.js:79:32)\n    at CHARACTER.damage (/home/mud/mud/world/extends/char/combat.js:418:31)\n    at CHARACTER.do_attack (/home/mud/mud/world/extends/char/combat.js:219:25)\n    at CHARACTER.auto_attack (/home/mud/mud/world/extends/char/auto_combat.js:49:23)\n    at listOnTimeout (node:internal/timers:605:17)\n    at process.processTimers (node:internal/timers:541:7)"}
```

## 最近部署（deploy.log 末尾 20 行）

```
[2026-08-21 22:20:06] 前端构建完成 da466dd（www/ 已更新）
...
✓ built in 386ms
[2026-08-21 22:25:06] 前端构建完成 da466dd（www/ 已更新）
```
