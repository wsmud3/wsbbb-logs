...
**心跳**: 2026-08-23 18:22:02 UTC / 北京时间 2026-08-24 02:22:02

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 0 | 0 | 0d 6h 44m |
| 正式服(200) | running | 0 | 0 | 0d 8h 1m |

## Web 服务

- status: ok | 运行 0d 8h 1m | rss 98MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3760 | 96MB | 0d 6h 44m |
| mud-game | online | 3688 | 93MB | 0d 8h 1m |
| mud-web | online | 3598 | 98MB | 0d 8h 1m |
...
✓ built in 406ms
[2026-08-23 18:20:06] 前端构建完成 4015058（www/ 已更新）
```
