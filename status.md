...
**心跳**: 2026-08-24 14:52:01 UTC / 北京时间 2026-08-24 22:52:01

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 3 | 0 | 0d 16h 40m |
| 正式服(200) | running | 0 | 0 | 1d 4h 31m |

## Web 服务

- status: ok | 运行 1d 4h 31m | rss 99MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3764 | 100MB | 0d 16h 40m |
| mud-game | online | 3688 | 96MB | 1d 4h 31m |
| mud-web | online | 3598 | 99MB | 1d 4h 31m |
...
✓ built in 380ms
[2026-08-24 14:50:08] 前端构建完成 4015058（www/ 已更新）
```
