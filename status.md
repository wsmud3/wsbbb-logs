...
**心跳**: 2026-08-28 18:17:01 UTC / 北京时间 2026-08-29 02:17:01

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 0 | 0 | 2d 5h 3m |
| 正式服(200) | running | 0 | 0 | 3d 5h 56m |

## Web 服务

- status: ok | 运行 3d 5h 56m | rss 96MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3771 | 100MB | 2d 5h 3m |
| mud-game | online | 3694 | 97MB | 3d 5h 56m |
| mud-web | online | 3604 | 96MB | 3d 5h 56m |
...
[2026-08-28 18:15:07] 错误：前端构建失败 2773c3b，前端保持旧版本，下轮自动重试
```
