...
**心跳**: 2026-08-21 19:57:02 UTC / 北京时间 2026-08-22 03:57:02

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 1 | 1 | 0d 0h 24m |
| 正式服(200) | running | 0 | 0 | 0d 10h 25m |

## Web 服务

- status: ok | 运行 0d 10h 25m | rss 99MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3730 | 90MB | 0d 0h 24m |
| mud-game | online | 3668 | 97MB | 0d 10h 25m |
| mud-web | online | 3579 | 99MB | 0d 10h 25m |
...
✓ built in 452ms
[2026-08-21 19:55:06] 前端构建完成 da466dd（www/ 已更新）
```
