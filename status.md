...
**心跳**: 2026-08-28 01:32:01 UTC / 北京时间 2026-08-28 09:32:01

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 1 | 0 | 1d 12h 18m |
| 正式服(200) | running | 0 | 0 | 2d 13h 11m |

## Web 服务

- status: ok | 运行 2d 13h 11m | rss 100MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3771 | 99MB | 1d 12h 18m |
| mud-game | online | 3694 | 96MB | 2d 13h 11m |
| mud-web | online | 3604 | 100MB | 2d 13h 11m |
...
[2026-08-28 01:30:06] 错误：前端构建失败 c08aa74，前端保持旧版本，下轮自动重试
```
