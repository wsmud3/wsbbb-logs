...
**心跳**: 2026-08-28 13:52:02 UTC / 北京时间 2026-08-28 21:52:02

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 2 | 1 | 2d 0h 38m |
...
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3771 | 99MB | 2d 0h 38m |
| mud-game | online | 3694 | 97MB | 3d 1h 31m |
| mud-web | online | 3604 | 101MB | 3d 1h 31m |
...
[2026-08-28 13:50:09] 错误：前端构建失败 2773c3b，前端保持旧版本，下轮自动重试
[2026-08-28 13:50:09] 中止：前端构建失败，暂不 reload，等待下一轮重试
```
