...
**心跳**: 2026-08-22 19:07:02 UTC / 北京时间 2026-08-23 03:07:02

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 0 | 0 | 0d 0h 51m |
| 正式服(200) | running | 0 | 0 | 0d 0h 51m |

## Web 服务

- status: ok | 运行 0d 0h 51m | rss 91MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3748 | 90MB | 0d 0h 51m |
| mud-game | online | 3677 | 88MB | 0d 0h 51m |
| mud-web | online | 3587 | 91MB | 0d 0h 51m |
...
✓ built in 374ms
[2026-08-22 19:05:06] 前端构建完成 9cccc3e（www/ 已更新）
```
