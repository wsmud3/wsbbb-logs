...
**心跳**: 2026-08-28 23:07:02 UTC / 北京时间 2026-08-29 07:07:02

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 0 | 0 | 2d 9h 53m |
| 正式服(200) | running | 0 | 0 | 3d 10h 46m |

## Web 服务

- status: ok | 运行 3d 10h 46m | rss 100MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3771 | 99MB | 2d 9h 53m |
| mud-game | online | 3694 | 97MB | 3d 10h 46m |
| mud-web | online | 3604 | 100MB | 3d 10h 46m |
...
[2026-08-28 23:05:06] 错误：前端构建失败 2773c3b，前端保持旧版本，下轮自动重试
```
