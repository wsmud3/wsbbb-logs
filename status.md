...
**心跳**: 2026-08-26 23:07:01 UTC / 北京时间 2026-08-27 07:07:01

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 2 | 0 | 0d 9h 53m |
| 正式服(200) | running | 0 | 0 | 1d 10h 46m |

## Web 服务

- status: ok | 运行 1d 10h 46m | rss 99MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3771 | 97MB | 0d 9h 53m |
| mud-game | online | 3694 | 97MB | 1d 10h 46m |
| mud-web | online | 3604 | 99MB | 1d 10h 46m |
...
[2026-08-26 23:05:06] 错误：前端构建失败 767c885，前端保持旧版本，下轮自动重试
```
