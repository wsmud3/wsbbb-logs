...
**心跳**: 2026-08-28 12:57:02 UTC / 北京时间 2026-08-28 20:57:02

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 0 | 0 | 1d 23h 43m |
| 正式服(200) | running | 0 | 0 | 3d 0h 36m |

## Web 服务

- status: ok | 运行 3d 0h 36m | rss 101MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3771 | 99MB | 1d 23h 43m |
| mud-game | online | 3694 | 97MB | 3d 0h 36m |
| mud-web | online | 3604 | 101MB | 3d 0h 36m |
...
[2026-08-28 12:55:08] 错误：前端构建失败 c08aa74，前端保持旧版本，下轮自动重试
```
