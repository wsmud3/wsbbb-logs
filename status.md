...
**心跳**: 2026-08-22 13:57:02 UTC / 北京时间 2026-08-22 21:57:02

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 1 | 0 | 0d 3h 13m |
| 正式服(200) | running | 0 | 0 | 0d 2h 3m |

## Web 服务

- status: ok | 运行 1d 4h 25m | rss 101MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3740 | 95MB | 0d 3h 13m |
| mud-game | online | 3669 | 89MB | 0d 2h 3m |
| mud-web | online | 3579 | 101MB | 1d 4h 25m |
...
✓ built in 405ms
[2026-08-22 13:55:07] 前端构建完成 da466dd（www/ 已更新）
```
