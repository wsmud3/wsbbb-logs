...
**心跳**: 2026-08-25 13:02:02 UTC / 北京时间 2026-08-25 21:02:02
...
| 正式服(200) | running | 1 | 0 | 0d 0h 41m |

## Web 服务

- status: ok | 运行 0d 0h 41m | rss 93MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3770 | 90MB | 0d 0h 41m |
| mud-game | online | 3694 | 90MB | 0d 0h 41m |
| mud-web | online | 3604 | 93MB | 0d 0h 41m |
...
[2026-08-25 13:00:07] 错误：前端构建失败 c74af0e，前端保持旧版本，下轮自动重试
```
