...
**心跳**: 2026-08-25 21:12:01 UTC / 北京时间 2026-08-26 05:12:01

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 3 | 1 | 0d 8h 51m |
| 正式服(200) | running | 1 | 0 | 0d 8h 51m |
...
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3770 | 98MB | 0d 8h 51m |
| mud-game | online | 3694 | 96MB | 0d 8h 51m |
| mud-web | online | 3604 | 98MB | 0d 8h 51m |
...
[2026-08-25 21:10:06] 错误：前端构建失败 767c885，前端保持旧版本，下轮自动重试
```
