...
**心跳**: 2026-08-21 23:52:02 UTC / 北京时间 2026-08-22 07:52:02

## 游戏服

| 服务器 | 状态 | 在线 | 连接 | 运行时长 |
| --- | --- | --- | --- | --- |
| 本地测试(100) | running | 1 | 1 | 0d 2h 1m |
| 正式服(200) | running | 1 | 0 | 0d 14h 20m |

## Web 服务

- status: ok | 运行 0d 14h 20m | rss 94MB

## pm2 进程

| 进程 | 状态 | restarts | 内存 | 运行时长 |
| --- | --- | --- | --- | --- |
| mud-game-test | online | 3731 | 96MB | 0d 2h 1m |
| mud-game | online | 3668 | 98MB | 0d 14h 20m |
| mud-web | online | 3579 | 94MB | 0d 14h 20m |
...
✓ built in 369ms
[2026-08-21 23:50:06] 前端构建完成 da466dd（www/ 已更新）
```
